...
sp_addmessage @msgnum = 53120, @severity=1, @msgtext = 'test user defined error msg', @replace = 'REPLACE'
GO
...
if exists (select * from sysobjects where name = 'Users2')
